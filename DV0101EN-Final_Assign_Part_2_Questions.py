...
#Plot 2 Calculate the average number of vehicles sold by vehicle type and represent as a Bar chart       
        ...
        R_chart2 = dcc.Graph(
            figure=px.bar(
                ...
                labels={'Automobile_Sales':'Average Sales', 'Vehicle_Type':'Type of Vehicle'}
            )
        )
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        R_chart4 = dcc.Graph(
            figure=px.bar(
                ...
                labels={'Automobile_Sales':'Average Sales', 'Vehicle_Type':'Type of Vehicle','unemployment_rate':'Unemployment Rate'}
            )
        )
...
# Plot 2 Total Monthly Automobile sales using line chart.
        Y_chart2 = dcc.Graph(
            figure=px.line(
                ...
                labels={'Month':'Months of the Year {}'.format(input_year),
                        'Automobile_Sales':'Total Sales'}
            )
        )
...
# Plot 3 bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(
            figure=px.bar(
                ...
                labels={'Vehicle_Type':'Type of Vehicle',
                        'Automobile_Sales':'Average Sales'}
            )
        )
# Plot 4 Total Advertisement Expenditure for each vehicle using pie chart
        ...
        Y_chart4 = dcc.Graph(
            figure=px.pie(
                ...
                names='Vehicle_Type',
                values='Advertising_Expenditure',
                title='Total Advertisement Expediture by Vehicle Type in the year {}'.format(input_year),
            )
        )
